                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <table>
                                ...
                                <?php 
                                $sql="SELECT * FROM `alocate_serial` where alocate=0 and dealer='JENDIE'";
                                ...
                                while ($row=mysqli_fetch_array($result)) {
                                    ...
                                    <td><?php $serial=$row['serial'];
                                    echo $row['serial'] ;?></td>
                                    <td>
                                      <a href="allocate_received.php?id=<?php echo $serial;?>"><button>receive</button></a> 
                                ...
                                while ($row=mysqli_fetch_array($result)) {
                                    ...
                                    echo $row['serial'] ;?></td>
                                    <td>
                                      <a href="allocate.php?id=<?php echo $serial;?>"><button>receive</button></a> 
