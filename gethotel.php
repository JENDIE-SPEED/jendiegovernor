                    ...
                    <ul class="metismenu" id="menu1">
                       <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index-1.php"><span class="mini-sub-pro">Create CERT</span></a></li>
            ...
            <div class="wrap-table100">
                <div class="table100 ver1 m-b-110">
                    <div class="table100-head">
                        <table>
   <form method="post" id="framework_form" action="allocate_stock.php">
    <div class="form-group">
     <tr><td><label>Select Serial</label></td>
     <td><select id="framework" name="framework[]" multiple class="form-control" >
      <?php
