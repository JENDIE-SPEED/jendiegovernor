                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
							...
							<td>
							<label>From</label>
							<input type="date" name="from_date"  class="form-control col-md-3 text-white bg-default"></td>
							<td>
							<label>To</label>
							<input type="date" name="to_date"  class="form-control col-md-3 text-white bg-default"></td>
                            <td>
                            ...
                            <?php
                            $role=$_SESSION['role'];
                             if ($role==='admin' && $user !='simsgit@gmail.com' && $user!='james.maina@jendiespeedgovernors.com' && $user !='kivati@jendiespeedgovernors.com') {
                                 # code...
                                ?>
                                  <script>
