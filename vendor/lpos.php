...
if(isset($_POST['submit'])){
	...
	$errors= array();
      ...
      if(empty($errors)==true){
         move_uploaded_file($file_tmp,"payments/".$file_name);
         //echo "Success";
		 $sql = "INSERT INTO payments (TransactionType, TransID, TransTime, TransAmount, BusinessShortCode, BillRefNumber, OrgAccountBalance, MSISDN, FirstName, MiddleName, LastName, date) VALUES ('$transtype', '$transid', '$transtime', '$transamount', '', '', '', '', '$fname', '$mname', '$lname', NOW())";
 ...
 <body>
  <div class="left-sidebar-pro">
   ...
   <div class="header-advance-area">
		...
		if(isset($_GET['q'])){
			$q = $_GET['q'];
			$sql="SELECT * from `payments` where  TransID LIKE '%".$q."%' OR FirstName LIKE '%".$q."%' LastName LIKE '%".$q."%' limit 10 ";
		}else{
