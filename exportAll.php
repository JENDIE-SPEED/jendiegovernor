...
require_once('TCPDF-master/tcpdf_import.php');
 ...
 {  
    ...
    $serial=$_GET['id'];
    $serial = '0'.$serial;
    $sql = "select * from data where vehicle='$serial' order by id desc limit 720";
	}else if(isset($_GET['6tp'])){ 
    $serial=$_GET['id'];
    $serial = '0'.$serial;
    $sql = "select * from data where vehicle='$serial' order by id desc limit 4320";
	}else if(isset($_GET['72tp'])){ 
    $serial=$_GET['id'];
    $serial = '0'.$serial;
    $sql = "select * from data where vehicle='$serial' order by id desc limit 51840";
	}else if(isset($_GET['vol'])){ 
    $serial=$_GET['id'];
    $serial = '0'.$serial;
    $sql = "select * from data where vehicle='$serial' and SUBSTRING(velocity,0,-3) > 80 order by id desc limit 720";
    }
