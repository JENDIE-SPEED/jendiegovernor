    ...
    <div class="form">
      <form action="insertdealer.php" method="post">
        ...
        <div class="row">
          ...
          <input type="text" name="pin"  placeholder="KRA PIN" required/>
        </div>
        <div class="row">
          <input type="text" name="business"  placeholder="BUSN REG NO."required/>
         <input type="text" name="adress"  placeholder="COMPANY ADRESS."required/>
        </div>
         <div class="row">
        ...
        <input type="text" name="number"  placeholder="Phone No"required/>
             ...
             <br/>
         <label style=" padding:20px;">Br</label>
         <select id = "myList" name="branch" required/>
         <?php 
         ...
         {
          ?>
               <option value = "<?php echo $row['location']; ?>" style=";width: 150px;"><?php echo $row['location']; ?></option>
               <?php
               }
               ?>
             </select>
