...
$(document).ready(function() {
  ...
  $("#addrow").click(function(){
    $(".item-row:last").after('<tr class="item-row"><td class="description"><div class="delete-wpr"><textarea>New online digital speed governor (One year subscription)</textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div></td><td><textarea class="cost">14000</textarea></td><td><textarea class="qty">1</textarea></td><td><textarea class="tax">1960</textarea></td><td><span class="price">15960</span></td></tr>');
