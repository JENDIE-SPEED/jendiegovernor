function print_today() {
  ...
  $(document).ready(function() {
    ...
    $("#addrow").click(function(){
      $(".item-row:last").after('<tr class="item-row"><td class="description"><div class="delete-wpr"><textarea>Valve</textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div></td><td><textarea class="cost">7000</textarea></td><td><textarea class="qty">1</textarea></td><td><textarea class="tax">980</textarea></td><td><span class="price">7980</span></td></tr>');
