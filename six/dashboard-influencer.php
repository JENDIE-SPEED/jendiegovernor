	                                            ...
	                                            <div class="user-avatar-info">
	                                                <div class="m-b-20">
	                                                    <div class="user-avatar-name">
	                                                        <h2 class="mb-1"><?php echo $company?></h2>
	                                                    </div>
	                                                    <div class="rating-star  d-inline-block">
	                                                        <i class="fa fa-fw fa-star"></i>
	                                                        
	                                                        <p class="d-inline-block text-dark"><?php
                                        $sql="SELECT * from `work` where dealer='$company'";
                                        $query=mysqli_query($conn,$sql)or die($conn);
                                        echo $num=mysqli_num_rows($query);?>Installations </p>
	                                                    </div>
	                                                </div>
	                                                <!--  <div class="float-right"><a href="#" class="user-avatar-email text-secondary">www.henrybarbara.com</a></div> -->
	                                                <div class="user-avatar-address">
	                                                    <p class="border-bottom pb-3">
	                                                        <span class="d-xl-inline-block d-block mb-2"><i class="fa fa-map-marker-alt mr-2 text-primary "></i><?php
                                        $sql="SELECT * from `users` where `email`='$company_email'";
                                        $query=mysqli_query($conn,$sql)or die($conn);
                                        $row=mysqli_fetch_array($query);
                                        echo $row['branch'];?></span>
	                                                        <span class="mb-2 ml-xl-4 d-xl-inline-block d-block"><?php echo date('Y-m-d');?>  </span>
