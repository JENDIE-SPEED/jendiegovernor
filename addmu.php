...
<body>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>Unconfirmed Stock</b></h4>
                            ...
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                ...
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    ...
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        ...
                                        if ($company==="JENDIE") {
                                            # code...
                                            $sql2="SELECT * FROM `alocate_serial` where alocate=1 and sold=0 and dealer='$company'";
                                        $query2=mysqli_query($conn,$sql2) or die($conn);
                                        echo $num=mysqli_num_rows($query2); 
                                        } else {
                                            # code...
                                            $sql2="SELECT * FROM `alocate_serial` where alocate=1 and dealer='$company' and sold=0";
                                        $query2=mysqli_query($conn,$sql2) or die($conn);
                                        echo $num=mysqli_num_rows($query2); 
                                        }
  ...
  <form method="post" action="joe.php" enctype="multipart/form-data">
                        ...
                        <table class="table table-bordered table-striped table-hover">
                          ...
                          <td><input type="file" name="file" required/></td>
                                ...
                                <tr class="success">
                                  ...
                                  <td><button class="btn btn-success btn-mini" type="submit" name="submit"> <strong>ADD</strong></button></td>
