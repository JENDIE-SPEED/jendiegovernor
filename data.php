...
if ($data=='jam') {
	# code...
	$sql="UPDATE work set status_renew=1 where `serial`= '$serial'";
...
$gen="unique id:".$vin."\nregistration:".$reg."\nexpiry: ".$newdate ;
 ...
 echo "NO DATA FOR THE LAST 24HRs VISIT THE NEAREST DEALER TO CHECK YOUR VEHICLE OR CALL 0720522544 ";
	//header('location:data_checker.php?serial='.$serial.'');
}
