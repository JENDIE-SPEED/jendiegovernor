...
$user=  $_SESSION['user'];
	...
	if(isset($_POST['update'])){
		$phone = $_POST['phone'];
		//echo "alert('Hello')";
		$query = "UPDATE work SET phone = '$phone' WHERE serial = '$id'";
...
<head>
  ...
  <link rel="icon" type="image/png" href="images/icons/favicon.ico"/>
   <link href="http://netdna.bootstrapcdn.com/twitter-bootstrap/2.2.2/css/bootstrap-combined.min.cssrowtylesheet">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li id="removable">
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="Renewal " href="renewal.php"><span class="mini-sub-pro">Renewal</span></a></li>
                                <li><a title="Batch" href="batch.php"><span class="mini-sub-pro">Batch Renewal</span></a></li>
                        ...
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
                                <tr class="info">
                                        ...
                                        <td><strong >Current Phone:</strong></td>
                          <td><?php echo $row['phone']; ?></td>
                          <td><strong >New Phone</strong></td>
