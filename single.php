            ...
            <div class="wrap-table100">
                <div class="table100 ver1 m-b-110">
                    <div class="table100-head">
                        <table  >
   <form method="post" id="framework_form" enctype="multipart/form-data" action="single_stock.php" >
     ...
     </select></td> </tr><tr><td width="80px"> <label> Client</label></td>
    <td> <input type="text" name="single"></td>
                            </tr>
                            <tr>
                                <td width="80px">
                                 <label> Price</label>
