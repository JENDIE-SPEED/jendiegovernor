                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                            	<li><a title="SCAN" href="index1.php"><span class="mini-sub-pro"> SCAN</span></a></li>
                             <li><a title="Dealer" href="../accounts.php"><span class="mini-sub-pro">Dealer Allocate</span></a></li>
                                <li><a title="Client" href="../single.php"><span class="mini-sub-pro">Client Allocate</span></a></li>
                                <li><a title="quotation" href="../search_serial.php"><span class="mini-sub-pro">Search Serial</span></a></li>
                                <li><a title="quote hist" href="../presenter-list.php"><span class="mini-sub-pro">QUOTE HISTORY</span></a></li>
...
<tr><td>SERIAL</td><td><input type="text" name="item" /></td></tr>
...
echo"<tr width= 80px><th>ITEM:</th><th>QTY</th><th>ACTION</th></tr>";
while($row=mysql_fetch_array($result))
{
echo"<tr width= 80px>";
echo "<td align= center width= 100px>".$row['itemcode']."</td>";
echo "<td align=center width= 80px>".$row['item']."</td>";
