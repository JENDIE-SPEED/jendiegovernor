...
if(isset($_POST['search'])){
	$serial = $_POST['searchVehicle'];
	
	$sql="SELECT * FROM `work` WHERE serial='$serial' OR  reg_no = '$serial'";
...
if(isset($_POST['update'])){
	...
	$problem = mysqli_real_escape_string($conn, $_POST['budget']);
	$action=mysqli_real_escape_string($conn,$_POST['message']);
	$phone = mysqli_real_escape_string($conn,$_POST['phone']);
	
	$sql = "update work set cus_name = '$cus_name', contact = '$contact', make = '$make', model = '$model', chasis = '$chasis', reg_no = '$reg', tech = '$tech', problem = '$problem', action = '$action', phone = '$phone' where serial = '$serial'";
	
	if(mysqli_query($conn, $sql)){
		echo "<script> alert('Vehicle updated successifully'); </script>";
	} else{
		echo "<script> alert('Error occured while updating the vehicle'); </script>";
	}
                            ...
                            <div class="mobile-menu">
                                <nav id="dropdown">
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon Treriss-icon Treriss-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="analytics.html">Sales Analytics</a></li>
                                                                       ...
                                                                       <li><a data-toggle="collapse" data-target="#Chartsmob" href="#">Charts <span class="admin-project-icon Treriss-icon Treriss-down-arrow"></span></a>
                                        ...
                                        <li><a data-toggle="collapse" data-target="#Tablesmob" href="#">Tables <span class="admin-project-icon Treriss-icon Treriss-down-arrow"></span></a>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-15">
                                <h4 class="text-left text-uppercase"><b>Technicians</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    ...
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        ...
                                        echo $num=mysqli_num_rows($query); ?></h2>
                                    </div>
                                </div>
                        ...
                        if ($company==="JENDIE") {
                            ...
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>dealers</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                        ...
                        else
                        {
                            ?>
                             <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" style="margin-bottom:1px;">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>My Stock</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="text-left col-xs-3 mar-bot-15">
                                    </div>
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php
                                        $sql1="SELECT * FROM `alocate_serial` where alocate=1 and sold=0 and dealer='$company'";
                                        $query1=mysqli_query($conn,$sql1) or die($conn);
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>Installation</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="text-left col-xs-3 mar-bot-15">
                                    ...
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        <h2 class="text-right no-margin"><?php 
                                        $sql1="SELECT * FROM work where problem='INSTALLATION' and dealer='$company'";
                                        $query1=mysqli_query($conn,$sql1) or die($conn);
                                        echo $num=mysqli_num_rows($query1); 
                                        ?></h2>
                                    </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            <div class="admin-content analysis-progrebar-ctn res-mg-t-30">
                                <h4 class="text-left text-uppercase"><b>Virtual Store</b></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                    <div class="text-left col-xs-3 mar-bot-15">
                                    ...
                                    <div class="col-xs-9 cus-gh-hd-pro">
                                        ...
                                        if ($company==="JENDIE") {
                                            # code...
                                            $sql2="SELECT * FROM `alocate_serial` where alocate=0";
                                        $query2=mysqli_query($conn,$sql2) or die($conn);
                                        echo $num=mysqli_num_rows($query2); 
                                        } else {
                                            # code...
                                            $sql2="SELECT * FROM `alocate_serial` where alocate=0 and dealer='$company'";
                                        $query2=mysqli_query($conn,$sql2) or die($conn);
                                        echo $num=mysqli_num_rows($query2); 
                                        }
...
<input type="text" name="searchVehicle">
<input type="submit" name="search" value="Search">
  ...
  <div class="table100-body js-pscroll">
                        <table class="table table-bordered table-striped table-hover">
                          ...
                          <td><input type="text" name="cus_name" value="<?php if(isset($row['cus_name'])){ echo $row['cus_name']; } ?>" required/></td>
                          <td><strong >CONTACT</strong></td>
                          <td><input type="text" name="contact" value="<?php if(isset($row['contact'])){ echo $row['contact']; } ?>" required/></td>
                          ...
                          <td><input type="text" name="name" value="<?php if(isset($row['reg_no'])){ echo $row['reg_no']; } ?>" required/></td>
                           <td><strong >CHASIS</strong></td>
                          <td><input type="text" name="chasis" value="<?php if(isset($row['chasis'])){ echo $row['chasis']; } ?>" required/></td>
                          ...
                          <td><input type="text" name="model" value="<?php if(isset($row['model'])){ echo $row['model']; } ?>" required/></td>
                            ...
                            <tr class="info">
                              ...
                              <td>
                                   ...
                                   <input type="text" name="serial" value="<?php if(isset($row['serial'])){ echo $row['serial']; } ?>" required readonly/>
                           </td>
                              <td><strong>TECHNICIAN</strong></td>
                          <td><select name="service" required>
						  <option selected value="<?php if(isset($row['tech'])){ echo $row['tech']; } ?>"><?php if(isset($row['tech'])){ echo $row['tech']; } ?></option>
                            <?php
                            $sql="SELECT * from `technician` where dealer='$company'";
                                $result=mysqli_query($conn,$sql);
                                while ($row1=mysqli_fetch_array($result)) {
                                    $name=$row1['first_name']." ".$row1['second_name'];
                                    ?>
                                    <option value="<?php echo $name ?>"><?php echo $row1['first_name']." ".$row1['second_name']; ?></option>
    ...
    <tr class="info">
      ...
      <td><select name="budget"  required>
       
                            <option selected value="<?php if(isset($row['problem'])){ echo $row['problem']; } ?>"><?php if(isset($row['problem'])){ echo $row['problem']; } ?></option>
                            <option value="INSTALLATION">NEW INSTALLATION</option>
                            <!--<option value="SERVICE">SERVICE</option>-->
                            
      </select></td>
      <td><strong>COMMENT</strong></td>
      <td> <input type="text" name="message" value="<?php if(isset($row['action'])){ echo $row['action']; } ?>" required/></td>
    </tr>
    <tr class="info">
       <td><strong>Phone</strong></td>
      <td> <input type="text" name="phone" value="<?php if(isset($row['phone'])){ echo $row['phone']; } ?>" required/></td>
    </tr>
    <tr class="success">
      <td><strong>Upadte</strong></td>
      <td><button class="btn btn-success btn-mini" type="submit" name="update"> <strong>Update</strong></button></td>
