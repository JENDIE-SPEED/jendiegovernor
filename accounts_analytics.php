                        ...
                        <div class="income-dashone-total reso-mg-b-30">
                            <div class="income-dashone-pro">
                                ...
                                <div class="income-range order-cl">
                                    ...
                                    <span class="income-percentange bg-green"><a target="_blank" href="daily_reports.php">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5><a target="_blank" href="weekly_report.php"> WEEKLY INSTALLATIONS</a></h5>
                                <h2 class="counter">
                                    <?php
                                    if ($company==='JENDIE') {
                                             # code...
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                <h5><a target="_blank" href="week-renewals.php">WEEKLY RENEWALS</a></h5>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="analysis-progrebar reso-mg-b-30">
                            <div class="analysis-progrebar-content">
                                <h5><a target="_blank" href="monthly_report.php"> MONTHLY INSTALLATIONS </a></h5>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        <div class="analysis-progrebar reso-mg-b-30">
                            <div class="analysis-progrebar-content">
                                <h5><a target="_blank" href="monthly_renewals.php">MONTHLY RENEWALS</a> </h5>
                                <h2><span class="counter"><?php
                                if ($company==='JENDIE') {
                                             # code...
                                    $newdate = date ( 'm-Y'); 
