  ...
  <div class="left-sidebar-pro">
   ...
   <div class="header-advance-area">
			...
			<div class="alert alert-success" role="alert">
			  You have successifuly remove vehicle from transaction
			</div>
			<?php } else{ ?>
			<div class="alert alert-danger" role="alert">
			  Error occured while trying to remove vehicle
			</div>
			<?php 
			}
			} ?>
			...
			<label>From: &nbsp;&nbsp;&nbsp;</label><br>
			<input type="date" name="from" class="form-control form-control col-sm-2 float-left">&nbsp;&nbsp;&nbsp;
			<label>To: &nbsp;&nbsp;&nbsp;</label><br>
			<input type="date" name="to" class="form-control form-control col-sm-2 float-left">&nbsp;&nbsp;&nbsp;
			<a href="#" class="btn btn-primary col-sm-1">Query</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" class="btn btn-primary col-sm-1">Export</a>&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="text" name="search" id="search" class="form-control form-control col-sm-4 float-right" onkeyup="showVehicle(this.value)" placeholder="Search Transaction" value="<?php if(isset($_GET['q'])){ echo $_GET['q']; } ?>" data-toggle="tooltip" title="Hit Enter Keyboard Key to Search" required>
			</div>
			<br>
			</form> -->
			<br>
		...
		if(isset($_GET['id'])){
			$q = $_GET['id'];
			$sql="SELECT * from `work` where code ='$q' limit 100 ";
		}else{
			$sql="SELECT * from `work` where code ='jendie' limit 100 ";
		}
                                ...
                                while ($row=mysqli_fetch_array($result)) {
									...
									<tr id="datarow">
										...
										<td><a href="remove.php?id=<?php echo $row['id']; ?>&code=<?php echo $row['code']; ?>" onclick="return confirm('Are you sure you  want to remove vehicle from this transaction?')" class="btn btn-danger">Remove</a></td>
									</tr>
									<?php
                                }
...
function showVehicle(str) {
  ...
  var input = document.getElementById("search");
	...
	input.addEventListener("keyup", function(event) {
	  ...
	  if (event.keyCode === 13) {
		window.location.href = 'transactions.php?q='+str;	
  }
});
