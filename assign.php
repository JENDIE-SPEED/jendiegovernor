                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="review-tab-pro-inner">
                                <ul id="myTab3" class="tab-review-design">
                                    <li class="active"><a href="#description"><i class="icon treris-edit" aria-hidden="true"></i> ASSIGN PRESENTER</a></li>
                                            ...
                                            <form action="a.php" method="post">
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <select name="shortcode" class="form-control pro-edt-select form-control-primary"  >
                                                            <option>SHORT CODE</option>
                                                            <?php
                                                            $james="SELECT * FROM product ";
                                                            $r=mysqli_query($conn,$james);
                                                            while ($row=mysqli_fetch_array($r)) {
                                                                # code...
                                                                ?>
                                                                <option value="<?php echo $row['shortcode']; ?>"><?php echo $row['shortcode']; ?></option>
                                                ...
                                                <div class="review-content-section">
                                                    <div class="input-group mg-b-pro-edt">
                                                        <select name="user" class="form-control pro-edt-select form-control-primary"  >
                                                            ...
                                                            <?php
                                                            $sql="SELECT * FROM users where position='presenter'";
