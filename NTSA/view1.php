...
<head>
  ...
  <script type="text/javascript">
    ...
    function my_function(){
      $('#dataTable').load(location.href + ' #data');
    }
  </script>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
   ...
   <ul class="navbar-nav ml-auto ml-md-0">
      <li class="nav-item dropdown no-arrow mx-1">
        <a href="export_pdf.php?id=<?php echo $serial; ?><?php if(isset($_POST['date_value'])){ echo "&date=".$_POST['date_value'];}?>" target="_blank"><button class="btn btn-primary" type="button" >
          EXPORT VIOLATION DATA PDF
          </button></a>
        </li>
    </ul>
  ...
  <div id="wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Vehicle Speed and Tracking Information</div>
          <div class="card-body">
    ...
    <tr class="success">
      ...
      $sql = "select * from data1 where vehicle like'%".$serial."%' and date = '$new_date'  order by id desc limit 1000";  
      ...
      ?><tr id = "data">  
                          ...
                          <td> <?php $lati= $row['latitude'] ;
                          echo str_replace("N","S",$lati); ?></td>
                          <!-- <td> <?php 
						 //  $lat = $row['latitude'] ;
						 //  $log =  $row['longitude'];
						  
						 //  $lat = str_replace("N","S",$lat);
							...
							// }
						  ?>
						  // <a href=<?php  "https://maps.google.com/?q=".$new_lat.",".$new_log; ?> target="_blank">Maps</a>
						  </td> -->
						  <td>
      ...
      $sql = "select * from data1 where vehicle like'%".$serial."%' order by id desc limit 100";  
      $result = mysqli_query($connect, $sql);  
      while($row = mysqli_fetch_array($result))  
      {     
         $speed = $row['velocity'];
