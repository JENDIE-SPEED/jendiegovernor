...
require_once('TCPDF-master/tcpdf_import.php');
 ...
 {  
	  ...
	  if(isset($_GET['date'])){
		...
		$serial=$_GET['id'];
		$serial = '0'.$serial;
		 $sql = "select * from data where vehicle='$serial' and date = '$new_date' and velocity!='0KM/H' order by id desc limit 100";  
	  }else{
		...
		$serial=$_GET['id'];
		$serial = '0'.$serial;
		$sql = "select * from data where vehicle='$serial' and velocity!='0KM/H' order by id desc limit 100";
	  }
