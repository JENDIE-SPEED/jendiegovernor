...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <tr class="success">
      ...
      $sql = "select * from data where vehicle like'%".$serial."%' and date = '$new_date'  order by id desc limit 1000";  
      ...
      $sql = "select * from data where vehicle like'%".$serial."%' order by id desc limit 100";  
      $result = mysqli_query($connect, $sql);  
      while($row = mysqli_fetch_array($result))  
      {     
