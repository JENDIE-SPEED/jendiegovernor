                ...
                <nav class="sidebar-nav left-sidebar-menu-pro">
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                                ...
                                if ($name==='jendie') {
                                    ?>
                                    <li><a title="home" href="violation.php"><span class="mini-sub-pro">VIOLATION</span></a></li>
                                    <?
                                } 
                            ?>
                </nav>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <input type="text" name="search_text" id="search_text" placeholder="Search by Vehicle Reg/Cert id /Chassis" class="form-control" />
                            </div>
