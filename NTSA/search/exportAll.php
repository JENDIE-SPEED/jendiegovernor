...
require_once('TCPDF-master/tcpdf_import.php');
 ...
 {  
    ...
    $serial=$_GET['id'];
    $serial = '0'.$serial;
     $sql = "select * from data where vehicle='$serial' and date = '$new_date'  order by id desc limit 100";  
    }else{
    ...
    $serial=$_GET['id'];
    $serial = '0'.$serial;
    $sql = "select * from data where vehicle='$serial'  order by id desc limit 100";
    }
