...
$pdf->SetAuthor('Fireball Technologies');
$pdf->SetTitle('Fireball Technologies');
$pdf->SetSubject('vehicle governer');
 ...
 *+v+-+----Parameters t, s and f are required for a Macro Control Block, all other parametrs are optional.
