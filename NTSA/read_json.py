...
while True:
    ...
    with open('/opt/lampp/htdocs/jendiegovernor/NTSA/search/certs.log', 'r') as f:
        if os.stat('/opt/lampp/htdocs/jendiegovernor/NTSA/search/certs.log').st_size == 0:
            print('File is empty')
            sleep(5)
        else:
            ...
            file = open("/opt/lampp/htdocs/jendiegovernor/NTSA/search/certs.log","r+")
            file.truncate(0)
            file.close()
            sleep(5)
