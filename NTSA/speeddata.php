...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      <li class="nav-item dropdown no-arrow mx-1">
		...
		<li class="nav-item dropdown no-arrow mx-1">
        <a href="exportAll.php?id=<?php echo $serial;?>&1tp=1" target="_blank"><button class="btn btn-primary" type="button" >
           1TP PDF
          </button></a>
        </li>
		<li class="nav-item dropdown no-arrow mx-1">
        <a href="exportAll.php?id=<?php echo $serial; ?>&6tp=1" target="_blank"><button class="btn btn-primary" type="button" >
           6TP PDF
          </button></a>
        </li>
		<li class="nav-item dropdown no-arrow mx-1">
		...
		<li class="nav-item dropdown no-arrow mx-1">
        <a href="exportAll.php?id=<?php echo $serial; ?>&vol=1" target="_blank" ><button class="btn btn-primary" type="button" >
          VIOLATIONS
          </button></a>
        </li>
  ...
  <div id="wrapper">
    ...
    <tr class="success">
     ...
     $serial = '0'.$serial;
      $sql = "select * from data1 where vehicle ='$serial' AND velocity!='0KM/H' and velocity< '81KM/H' order by id desc limit 200";   
      $result = mysqli_query($connect, $sql);  
      while($row = mysqli_fetch_array($result))  
      {     
