...
require_once('TCPDF-master/tcpdf_import.php');
            ...
            $serial='16100003533';
            $sql="SELECT * FROM work WHERE `serial`='16100003533'";
 ...
 {  
    ...
    $serial=$_GET['id'];
    $serial = '0'.$serial;
     $sql = "select * from data1 where vehicle='$serial' and date = '$new_date'  order by id desc limit 1000";  
    }else{
    ...
    $serial='16100003533';
    $serial = '0'.$serial;
    $sql = "select * from data1 where vehicle='$serial'  and date='20-06-2020' and velocity!='0KM/H'  order by id desc limit 1000";
    }
