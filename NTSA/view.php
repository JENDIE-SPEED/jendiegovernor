  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <ul class="navbar-nav ml-auto ml-md-0">
      <li class="nav-item dropdown no-arrow mx-1">
		...
		<li class="nav-item dropdown no-arrow mx-1">
        <a href="1tp.php?id=<?php echo $serial;?>" target="_blank"><button class="btn btn-primary" type="button" >
           1TP PDF
          </button></a>
        </li>
		<li class="nav-item dropdown no-arrow mx-1">
        <a href="6tp.php?id=<?php echo $serial; ?>&6tp=1" target="_blank"><button class="btn btn-primary" type="button" >
           6TP PDF
          </button></a>
        </li>
		<li class="nav-item dropdown no-arrow mx-1">
        <a href="72.php?id=<?php echo $serial; ?>" target="_blank"><button class="btn btn-primary" type="button" >
           72HRS PDF
          </button></a>
        </li>
		<li class="nav-item dropdown no-arrow mx-1">
        <a href="violations.php?id=<?php echo $serial; ?>" target="_blank"><button class="btn btn-primary" type="button" >
           VIOL PDF
          </button></a>
        </li>
  ...
  <div id="wrapper">
      ...
      <div class="container-fluid">
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Vehicle Speed and Tracking Information - TELEMETRY DATA Exported data is vehicle driving data</div>
          <div class="card-body">
    ...
    <tr class="success">
	 ...
	 if($serial == "016100010873"){
      ...
      $sql = "select * from data1 where vehicle = '$serial' and date = '$new_date'  order by id desc limit 200";  
	 }
     ...
     $previous_time = "";
     $serial = '0'.$serial;
      $sql = "select * from data1 where vehicle = '$serial' order by id desc limit 200";  
      $result = mysqli_query($connect, $sql);  
      while($row = mysqli_fetch_array($result))
//echo $row['id']." ";		  
      {     
        $current_time = $row['time'];
		//echo "previous_time".$previous_time."<br>";
