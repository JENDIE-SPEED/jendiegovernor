...
require_once('TCPDF-master/tcpdf_import.php');
      ...
      $obj_pdf->AddPage();
        ...
        $style = array(
            ...
            'bgcolor' => false
                ...
                $obj_pdf->Text(1,50,'N & L OF FITTING');
                $obj_pdf->Text(80,49,$location);
                ...
                $obj_pdf->Text(1,65,'FITTING AGENT NAME');
                ...
                $obj_pdf->Text(1,90,'DATE OF INSTALLATION.');
                $obj_pdf->Text(80,89,$date);
 ...
 {  
	  ...
	  if(isset($_GET['date'])){
		...
		$serial=$_GET['id'];
		$serial = '0'.$serial;
		 $sql = "select * from data1 where vehicle='$serial' and date = '$new_date' and velocity!='0KM/H' and velocity<='80KM/H'  order by id desc ";  
	  }else{
		...
		$serial=$_GET['id'];
		$serial = '0'.$serial;
		$sql = "select * from data1 where vehicle='$serial' and velocity!='0KM/H' and velocity < '80KM/H' order by id desc limit 200";
	  }
