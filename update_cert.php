...
$reg_no = $_POST['veh_reg'];
$query = "SELECT * from work WHERE serial = '$reg_no'";

$result = mysqli_query($conn, $query);
if(mysqli_num_rows($result) > 0)
{
$results = mysqli_fetch_array($result);
$cus_name=$results['cus_name'];
$contact=$results['contact'];
$make=$results['make'];
$model=$results['model'];
$chasis=$results['chasis'];
$reg = $results['reg_no'];
$tech = $results['tech'];
$serial=$results['serial'];
$problem = $results['problem'];
$action=$results['action'];
//$insuarer = $results['insuarer'];
...
var table = document.getElementById ("update_cert");
            table.refresh ();
</script>
<?php
}
...
<form method="post" action="">
                            ...
                            <tbody>
							<tr>
							<td><input type="text" name="veh_reg" placeholder="Registration Number"/>
							<input type="submit" name="submit" value="search" class="btn btn-success"/></td>
							<tr>
							</tbody>
							</table>
							</form>
  <form id="update_cert" method="post" action="update_work.php">
  <div class="table100-body js-pscroll">
                        <table class="table table-bordered table-striped table-hover">
                            <tbody>
                                <tr class="info">
                          <td><strong >NAME</strong></td>
                          <td><input type="text" name="cus_name" value="<?php if(isset($cus_name)){echo $cus_name; } ?>" required/></td>
                          <td><strong >CONTACT</strong></td>
                          <td><input type="text" name="contact" value="<?php if(isset($contact)){echo $contact; } ?>" required/></td>
                          ...
                          <td><input type="text" name="name" value="<?php if(isset($reg)){echo $reg; } ?>" required/></td>
                           <td><strong >CHASIS</strong></td>
                          <td><input type="text" name="chasis" value="<?php if(isset($chasis)){echo $chasis; } ?>" required/></td>
                          ...
                          <td><input type="text" name="make" value="<?php if(isset($make)){echo $make; } ?>" required/></td>
                          <td><strong >MODEL</strong></td>
                          <td><input type="text" name="model" value="<?php if(isset($model)){echo $model; } ?>" required/></td>
                            </tr> 
                             <tr class="info">
                            ...
                            <tr class="info">
                              ...
                              <td>
                                  <input type="text" name="serial" id="serial" value="<?php if(isset($serial)){echo $serial; } ?>" />
                           </td>
                              <td><strong>TECHNICIAN</strong></td>
                          <td><input name="service" value="<?php if(isset($tech)){echo $tech; } ?>" required/></td>
                            </tr>   
                            <tr class="info">
    ...
    <tr class="info">
      ...
      <td><input name="budget" value="<?php if(isset($problem)){echo $problem; } ?>" required/>
       </td>
      <td><strong>COMMENT</strong></td>
      <td> <input type="text" name="message" value="<?php if(isset($action)){echo $action; } ?>" required/></td>
    </tr>
    <tr class="info">
