<html>
    ...
    <div id='input'>
        ...
        mysql_connect("localhost", "root", "jameskinuthia") or
        ...
        $result = mysql_query("SELECT * FROM `data` where `vehicle`='016100009018' and `date`='22-05-2020' and `time` between '13:06:20'and '17:06:20'");
